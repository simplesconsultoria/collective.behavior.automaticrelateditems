var AutomaticRelatedItems = (function() {
  function AutomaticRelatedItems() {
    // Define texts
  ...
  AutomaticRelatedItems.prototype.render = function() {
  ...
  AutomaticRelatedItems.prototype.onClick = function(e) {
    e.preventDefault();
    $.ajax({
  ...
  AutomaticRelatedItems.prototype.onChangeTags = function(e) {
    e.preventDefault();
    if (this.$tags.val() === '') {
  ...
  AutomaticRelatedItems.prototype.addRelated = function(data) {
