...
from collective.behavior.automaticrelateditems.interfaces import IAddOnLayer
...
class InstallTestCase(unittest.TestCase):
    ...
    def test_setup_permission(self):
        permission = 'collective.behavior.automaticrelateditems: Setup'
    ...
    def test_version(self):
        profile = 'collective.behavior.automaticrelateditems:default'
